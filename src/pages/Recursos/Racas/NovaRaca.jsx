...
const NovaRaca = () => {
  ...
  const limiteMaximoFieldSx = {
    ...attributeFieldSx,
    '& .MuiOutlinedInput-root': {
      ...attributeFieldSx['& .MuiOutlinedInput-root'],
      '& fieldset': {
        ...attributeFieldSx['& .MuiOutlinedInput-root']['& fieldset'],
        borderColor: '#d4af37',
    ...
    '& .MuiInputLabel-root': {
      ...attributeFieldSx['& .MuiInputLabel-root'],
      '&:after': {
        content: '""',
        display: 'block',
        width: '100%',
